...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); //menu

var menuBtn = document.querySelector('.menu-btn');
var sideMenu = document.querySelector('.side-menu');
var closeBtn = document.querySelector('.close-btn'); // Open the sidebar

menuBtn.addEventListener("click", function () {
  sideMenu.classList.add("open"); // Show the sidebar

  menuBtn.classList.add("hidden"); // Hide the menu button

  document.body.classList.add("no-scroll");
}); // Close the sidebar

closeBtn.addEventListener("click", function () {
  sideMenu.classList.remove("open"); // Hide the sidebar

  menuBtn.classList.remove("hidden"); // Show the menu button
